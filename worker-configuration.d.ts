// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 2d53524d6132852c12575d39f4caf3d6)
// Runtime types generated with workerd@1.20250320.0 2025-03-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		tasm_kv: KVNamespace;
		API_HOST: "http://localhost:8787" | "https://tasm-server.fathurrahmannotoy.workers.dev";
		JWT_ACCESS_SECRET: string;
		JWT_REFRESH_SECRET: string;
		CLIENT_ORIGIN_URL: string;
		tasm_bucket: R2Bucket;
		DB: D1Database;
	}
}
